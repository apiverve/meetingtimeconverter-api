...
namespace APIVerve.API.MeetingTimeConverter
{
    ...
    /// <summary>
    /// Client for the MeetingTimeConverter API
    /// </summary>
    public class MeetingTimeConverterAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/meetingtimeconverter";
        ...
        {
            { "time", new ValidationRule { Type = "string", Required = true, Format = "time" } },
            { "fromTimezone", new ValidationRule { Type = "string", Required = true, Format = "timezone" } },
            { "toTimezone", new ValidationRule { Type = "string", Required = true, Format = "timezone" } },
        ...
        public MeetingTimeConverterAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MeetingTimeConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MeetingTimeConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MeetingTimeConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MeetingTimeConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(MeetingTimeConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MeetingTimeConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MeetingTimeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MeetingTimeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MeetingTimeConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MeetingTimeConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MeetingTimeConverterQueryOptions options)
        {
