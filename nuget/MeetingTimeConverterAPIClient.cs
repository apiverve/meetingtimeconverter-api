...
namespace APIVerve.API.MeetingTimeConverter
{
...
#endif
    {
        ...
        {
            { "time", new ValidationRule { Type = "string", Required = true } },
            { "fromTimezone", new ValidationRule { Type = "string", Required = true } },
            { "toTimezone", new ValidationRule { Type = "string", Required = true } },
