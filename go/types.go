...
// Request contains the parameters for the Meeting Time Converter API.
//
// Parameters:
...
type Request struct {
	...
	FromTimezone string `json:"fromTimezone"` // Required
	ToTimezone string `json:"toTimezone"` // Required
...
// ResponseData contains the data returned by the Meeting Time Converter API.
