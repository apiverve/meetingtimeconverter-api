# Meeting Time Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:meetingtimeconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.meetingtimeconverter.MeetingTimeConverterAPIClient;
import com.apiverve.meetingtimeconverter.APIResponse;
import com.apiverve.meetingtimeconverter.APIException;

// Initialize the client
MeetingTimeConverterAPIClient client = new MeetingTimeConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("time", "14:30");
    parameters.put("fromTimezone", "America/New_York");
    parameters.put("toTimezone", "Europe/London");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/meetingtimeconverter](https://docs.apiverve.com/ref/meetingtimeconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/meetingtimeconverter](https://docs.apiverve.com/ref/meetingtimeconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/meetingtimeconverter-api/issues)
