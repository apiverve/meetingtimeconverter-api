# Meeting Time Converter API - Examples

This folder contains example code for using the Meeting Time Converter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/meetingtimeconverter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/meetingtimeconverter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/meetingtimeconverter](https://docs.apiverve.com/ref/meetingtimeconverter)
