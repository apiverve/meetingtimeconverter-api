...
namespace APIVerve\Meetingtimeconverter;
...
/**
 * Client for the Meeting Time Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/meetingtimeconverter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/meetingtimeconverter';
    ...
    private const VALIDATION_RULES = [
        ...
        'fromTimezone' => ['type' => 'string', 'required' => true, 'format' => 'timezone'],
        'toTimezone' => ['type' => 'string', 'required' => true, 'format' => 'timezone'],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MeetingtimeconverterClient] {$message}\n";
        }
    }
}
