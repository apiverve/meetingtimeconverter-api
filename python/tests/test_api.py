...
class TestMeetingtimeconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MeetingtimeconverterAPIClient(self.api_key)

    @patch('apiverve_meetingtimeconverter.apiClient.requests.get')
